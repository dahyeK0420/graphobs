...
from graph_observability_kit._observability.payload_policy import payload_summary
...
INTERNAL_LOGGER = stdlib_logging.getLogger("graph_observability_kit.logging")
NS_PER_MS = 1_000_000
